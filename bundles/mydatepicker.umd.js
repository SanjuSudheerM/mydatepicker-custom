...
var MyDatePicker = (function () {
    ...
    MyDatePicker.prototype.onUserDateInput = function (value) {
        ...
        if (value.length === 0) {
            ...
            var date = this.utilService.isDateValid(value, 'mm-dd-yyyy', this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableWeekends, this.opts.disableDays, this.opts.disableDateRanges, this.opts.monthLabels, this.opts.enableDays);
    ...
    MyDatePicker.prototype.customDateMasking = function (value) {
        var dateFormat = 'mm-dd-yyyy';
        var manualInputLength = value.length;
        var constructedDate = '';
        var dateParts;
        if (manualInputLength > 0) {
            ...
            if (dateParts.length == 3) {
                ...
                console.log(this.selectionDayTxt, constructedDate);
            }
        }
    };
    MyDatePicker.prototype.limitInputLength = function (event) {
